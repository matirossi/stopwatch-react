...
const LapContainer = ({ elapsedTime, laps, totalLapsElapsedTime }) => {
    ...
    return (
        <ul className="laps-list">
            ...
            {laps && laps.map((lapObj) => {
                return <li key={lapObj.lapNumber} className="lap"><span>Lap {lapObj.lapNumber}</span><span>{updateTimer(lapObj.lapElapsedTime)}</span></li>
            })}
